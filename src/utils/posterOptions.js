...
export const TEMPLATES = {
  threeForTwo: { label: 'Promoción 3×2', category: 'offers', favorite: true, description: 'Llevás tres y pagás dos', offerLabel: '3×2', tagline: 'LLEVÁS 3 · PAGÁS 2', stampShape: 'burst', promotion: { type: 'payLess', quantity: 3, payQuantity: 2 }, colors: { posterBackground: '#f7fee7', borderCustomColor: '#062719', innerBorderColor: '#86efac', offerBackground: '#062719', offerTextColor: '#a3e635', offerShadowColor: '#22c55e', stampStartColor: '#a3e635', stampEndColor: '#4ade80', stampTextColor: '#062719', stampBackdropColor: '#facc15', priceColor: '#087a3e', productTextColor: '#062719' } },
  fourForThree: { label: 'Promoción 4×3', category: 'offers', favorite: true, description: 'Llevás cuatro y pagás tres', offerLabel: '4×3', tagline: 'LLEVÁS 4 · PAGÁS 3', stampShape: 'burst', promotion: { type: 'payLess', quantity: 4, payQuantity: 3 }, colors: { posterBackground: '#07130d', borderCustomColor: '#83f52c', innerBorderColor: '#22c55e', offerBackground: '#83f52c', offerTextColor: '#07130d', offerShadowColor: '#166534', stampStartColor: '#facc15', stampEndColor: '#eab308', stampTextColor: '#07130d', stampBackdropColor: '#4ade80', priceColor: '#83f52c', productTextColor: '#ffffff' } },
  threeForPrice: { label: '3 por $1.000', category: 'offers', favorite: true, description: 'Tres unidades a precio cerrado', offerLabel: '3 POR', tagline: 'PRECIO FINAL DEL COMBO', stampShape: 'pill', promotion: { type: 'bundle', quantity: 3 }, price: '1.000', colors: { posterBackground: '#f7fee7', borderCustomColor: '#062719', innerBorderColor: '#4ade80', offerBackground: '#062719', offerTextColor: '#facc15', offerShadowColor: '#22c55e', stampStartColor: '#facc15', stampEndColor: '#fde047', stampTextColor: '#062719', stampBackdropColor: '#86efac', priceColor: '#062719', productTextColor: '#062719' } },
  twoForPrice: { label: '2 por $1.000', category: 'offers', description: 'Dos unidades a precio cerrado', offerLabel: '2 POR', tagline: 'APROVECHÁ EL PRECIO COMBO', stampShape: 'pill', promotion: { type: 'bundle', quantity: 2 }, price: '1.000', colors: { posterBackground: '#07130d', borderCustomColor: '#a3e635', innerBorderColor: '#22c55e', offerBackground: '#a3e635', offerTextColor: '#07130d', offerShadowColor: '#166534', stampStartColor: '#22c55e', stampEndColor: '#15803d', stampTextColor: '#ffffff', stampBackdropColor: '#facc15', priceColor: '#facc15', productTextColor: '#ffffff' } },
  rincon: { label: 'Identidad Rincón', category: 'new', favorite: true, description: 'Negro y verde de la marca', offerLabel: 'OFERTA', tagline: 'EL ALMACÉN DE TU BARRIO', stampShape: 'pill', colors: { posterBackground: '#f1f8ef', borderCustomColor: '#062719', innerBorderColor: '#4ade80', offerBackground: '#062719', offerTextColor: '#83f52c', offerShadowColor: '#22c55e', stampStartColor: '#83f52c', stampEndColor: '#22c55e', stampTextColor: '#062719', stampBackdropColor: '#bbf7d0', priceColor: '#087a3e', productTextColor: '#062719' } },
