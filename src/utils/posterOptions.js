...
export const TEMPLATES = {
  quantityPromo: { label: 'Promo configurable 2×1', category: 'offers', favorite: true, description: 'Editá cuánto llevás y pagás', offerLabel: '2×1', tagline: 'LLEVÁS 2 · PAGÁS 1', stampShape: 'pill', promotion: { type: 'payLess', quantity: 2, payQuantity: 1 }, positions: { business: { x: 50, y: 7 }, offer: { x: 50, y: 27 }, stamp: { x: 50, y: 43 }, image: { x: 50, y: 55 }, price: { x: 50, y: 67 }, product: { x: 50, y: 84 } }, colors: { posterBackground: '#f7fee7', borderCustomColor: '#062719', innerBorderColor: '#4ade80', offerBackground: '#062719', offerTextColor: '#a3e635', offerShadowColor: '#22c55e', stampStartColor: '#a3e635', stampEndColor: '#84cc16', stampTextColor: '#062719', stampBackdropColor: '#bbf7d0', priceColor: '#087a3e', productTextColor: '#062719' } },
  bundlePromo: { label: 'Promo configurable 2×$1.000', category: 'offers', favorite: true, description: 'Editá cantidad y precio final', offerLabel: '2×', tagline: 'TODO POR SOLO', stampShape: 'pill', promotion: { type: 'bundle', quantity: 2 }, price: '1.000', positions: { business: { x: 50, y: 7 }, offer: { x: 50, y: 25 }, stamp: { x: 50, y: 41 }, image: { x: 50, y: 53 }, price: { x: 50, y: 64 }, product: { x: 50, y: 83 } }, colors: { posterBackground: '#07130d', borderCustomColor: '#a3e635', innerBorderColor: '#22c55e', offerBackground: '#a3e635', offerTextColor: '#07130d', offerShadowColor: '#166534', stampStartColor: '#ffffff', stampEndColor: '#dcfce7', stampTextColor: '#062719', stampBackdropColor: '#22c55e', priceColor: '#facc15', productTextColor: '#ffffff' } },
