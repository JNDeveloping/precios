...
export function BarcodeScannerModal({ open, onClose, onFound, onNeedPhoto }) {
  ...
  return (
    <div className="no-print fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="w-full max-w-xl rounded-[2rem] bg-white p-4 shadow-2xl">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-xl font-black text-gray-950"><Camera className="mr-2 inline" /> Escanear código</h2>
