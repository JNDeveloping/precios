...
export function TemplateRenderer({ templateId = DEFAULT_TEMPLATE_ID, poster, printRef, animated = false }) {
  ...
  return (
    <div
      ...
      className={animated ? 'template-renderer template-renderer--animated' : 'template-renderer'}
